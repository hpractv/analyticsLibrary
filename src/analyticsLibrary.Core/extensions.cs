...
using static analyticsLibrary.Core.loopDateRange;
...
namespace analyticsLibrary.Core
{
    public static class extensions
    {
        ...
        public static bool containsColumn(this System.Data.DataRow row, string column)
        {
            return row.Table.Columns.Cast<System.Data.DataColumn>().Any(c => c.ColumnName.Equals(column, StringComparison.OrdinalIgnoreCase));
        }
    }
}
